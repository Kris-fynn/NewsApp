...
getArticles = () => {
    axios
      .get(
        "https://newsapi.org/v2/everything?q=apple&from=2022-08-01&to=2022-08-01&sortBy=popularity&apiKey=c66fcadc80e94f12aaf3e60e1970a757"
      )
      .then(response =>
...
render = () => {
    ...
    return(
    <Card key={url} style={{marginTop:10, borderColor:'blue', borderRadius:5, borderBottomWidth:1}}
